 ...
 */
public class OficialManagementDetailsActivity extends Activity {
	...
	private void thread() {
		progressDialog = ProgressDialog.show(OficialManagementDetailsActivity.this, "", getResources().getString(R.string.get_date), true, false);
		new Thread()
		{
			@Override
			public void run() {
	...
	private void  date() {
		...
		returnparams.add("isFJ");
		 ...
		 Log.v("----OficialManagementDetailsA", blockdata.size() + "---");
	}
	/**
	 * 审核按钮
	 * @author yangchao
	...
	class auditClickListener implements OnClickListener{
		...
		public void onClick(View v) {
			...
			Intent intent = new Intent(OficialManagementDetailsActivity.this,AuditActivity.class); 
	...
	class backClickListener implements OnClickListener{
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Intent intent = new Intent(OficialManagementDetailsActivity.this,FinanciaBorrowActivity.class); 
			intent.putExtra("main", main);
			intent.putExtra("MIDkey", MIDkey);
			startActivity(intent);
			finish();
	...
	class downloadClickListener implements OnClickListener{
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Intent intent = new Intent(OficialManagementDetailsActivity.this,DownloadBorrowActivity.class);
			intent.putExtra("main", main);
			intent.putExtra("MIDkey", MIDkey);
			intent.putExtra("guid", guid);
			intent.putExtra("title", title);
