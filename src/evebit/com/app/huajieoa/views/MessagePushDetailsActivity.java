 ...
 */
public class MessagePushDetailsActivity extends Activity {
	...
	String [] key = {"010100","010101","01040202","010408","01040600","011200"
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		PushID =(String)getIntent().getExtras().get("PushID");
		for (int i = 1; i <= Integer.parseInt(PushID); i++) {
			NotificationManager manager = (NotificationManager)this.getSystemService(NOTIFICATION_SERVICE);
			manager.cancel(i);//删除状态栏的通知
		}
	...
	private void thread() {
		progressDialog = ProgressDialog.show(MessagePushDetailsActivity.this, "", getResources().getString(R.string.get_date), true, false);
		new Thread()
		{
			@Override
			public void run() {
	...
	private void  date() {
		...
		for (int i = 0; i < keyNameArrayList.size(); i++) {
		 ...
		 Log.v("----MessagePushDetailsA", blockdata.size() + "---");
	}
	...
	class auditClickListener implements OnClickListener{
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Intent intent = new Intent(MessagePushDetailsActivity.this,AuditActivity.class); 
	...
	class backClickListener implements OnClickListener{
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Intent intent = new Intent(MessagePushDetailsActivity.this,FinanciaBorrowActivity.class); 
			intent.putExtra("main", main);
			intent.putExtra("MIDkey", MIDkey);
			startActivity(intent);
			finish();
